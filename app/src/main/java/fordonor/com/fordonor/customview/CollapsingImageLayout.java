package fordonor.com.fordonor.customview;
...
public class CollapsingImageLayout extends FrameLayout {
    ...
    class OnOffsetChangedListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
            ...
            ForDonorTextView profile_about_tv=(ForDonorTextView)findViewById(R.id.profile_about_tv);
            ForDonorTextView age_tv=(ForDonorTextView)findViewById(R.id.age_tv);
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (child.getId() == R.id.profile_name_tv) {
                ...
                if (child.getId() == R.id.profile_about_tv) {
            ...
            //////////////TO HIDE TOOLBAR AND OTHER DETAILS AFTER COLLAPSE///////////
            if (verticalOffset != 0){
                //profile_toolbar.setVisibility(GONE);
                profile_about_tv.setVisibility(GONE);
                age_tv.setVisibility(GONE);
            }else {
                //profile_toolbar.setVisibility(VISIBLE);
                profile_about_tv.setVisibility(VISIBLE);
                age_tv.setVisibility(VISIBLE);
            }
        }
    }
